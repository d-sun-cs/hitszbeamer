...
\begin{frame}{国内外研究现状及分析}
    ...
    \footnotesize
    Two-tone Shift-XOR Codes\cite{fuTwotoneShiftXORStorage2021}在ZD码基础上，提出改进的递增差（RID）性质\cite{fuDecodingRepairSchemes2020}、连续可解性理论\cite{chengSuccessivelySolvableShiftAdd2021}，与双子系统移位异或消除法\cite{fuTwotoneShiftXORStorage2021}，得到更规范高效的移位异或纠删码。
